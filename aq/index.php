...
<div id="headerAll">
	...
	<div id="header">
    	...
    	<div id="top">
		<a  class="logo" href="index.htm" tppabs="http://bmm1105.com:99/" onclick="sendHotClick('http://bmm1105.com:99/HEADER.TO.LOGO');"><cite>
		<script LANGUAGE="Javascript">document.write(unescape("%3Ctitle%3E%u9996%u9875%3C/title%3E"))</SCRIPT><br /></cite></a>
        	<div class="right_info">
            <ul>
			
<img src="images/db1.png" tppabs="http://bmm1105.com:99/images/db1.png">
            </ul>
            </div>
			<!-- 注.中秋运营 
			<a class="tmp_mid_autumn"  href="#" target="_blank" onclick="sendHotClick('HEADER.TO.LOGO');">
    	...
    	<div id="menu">
        	<ul>
            <li id="menu_index"><a class="m1" href="#"><cite>首页</cite></a></li>
<img src="images/db2.png" tppabs="http://bmm1105.com:99/images/db2.png">
            </ul>
        </div>
		
		<script type="text/javascript">
		G_loginTimePoints[1] = new Date();//导航显示
		</script>
		
   	   <a class="handheld" href="javascript:if(confirm('http://bmm1105.com:99/app  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ������������ļ�δ�ҵ���  \n\n�����ڷ������ϴ���?'))window.location='http://bmm1105.com:99/app'" tppabs="http://bmm1105.com:99/app" target="_blank"></a>
...
<div class="login" id="login_alert" style="display:block;z-index:10003;">
        	<h3>用户登录</h3>
			<iframe style="background-color:transparent;" allowTransparency="false" name="embed_login_frame" id="embed_login_frame" frameborder="0" scrolling="no" width="100%" height="100%" src="login/login.php"></iframe>
        </div>
...
<!--Login End-->
<div style="text-align: center;"><span style="line-height: 1.5;"><img src="images/db.png" tppabs="http://bmm1105.com:99/images/db.png"></span></div>
