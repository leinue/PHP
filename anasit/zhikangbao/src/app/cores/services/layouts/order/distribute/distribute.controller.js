(function() {
    ...
    angular
        ...
        .controller('BasicServicesOrderDistributeController', BasicServicesOrderDistributeController);

    /* @ngInject */
    function BasicServicesOrderDistributeController($mdDialog, $state, $scope, OrderService, RefreshService, $filter) {
        var vm = this;
        ...
        $('#detail-distribute').on('hidden.bs.modal', function (e) {
