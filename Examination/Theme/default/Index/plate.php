<?php  require('header.php'); ?>
	...
	<section>
		...
		<div class="d_body">
			...
			<div id="newest_cg" class="cg_display">
				<div class="cg_title">
					<ul>
						<li style="text-align:left!important;"><h3>最新动态</h3></li>
						<!-- <li><a href="plate.php">更多 ></a></li> -->
					</ul>
				</div>
			...
			<div class="cg_display cg_top10">
				<div class="cg_title">
					<ul>
						<li style="text-align:left!important;"><h3>本区排行</h3></li>
					</ul>
				</div>
				<div class="pixiv-form cg-theme">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.cg_top10').css('top',$('.motion-graphics').height()+$('introduction-home').height()-228).css({
