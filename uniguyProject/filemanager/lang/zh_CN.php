...
define('lang_File_Permission', '文件权限');
define('lang_File_Permission_Not_Allowed', 'Changing %s permissions are not allowed.'); // %s = files or folders
define('lang_File_Permission_Recursive', '确定要对此文件夹执行全部调用吗?');
define('lang_File_Permission_Wrong_Mode', "不被允许的权限操作");
define('lang_User', '用户');
define('lang_Group', '群体');
define('lang_Yes', 'Yes');
define('lang_No', 'No');
define('lang_Lang_Not_Found', '找不到语言包');
define('lang_Lang_Change', 'Change the language');
define('lang_File_Not_Found', '找不到文件');
define('lang_File_Open_Edit_Not_Allowed', 'You are not allowed to %s this file.'); // %s = open or edit
define('lang_Edit', '编辑');
define('lang_Edit_File', "编辑文件内容");
define('lang_File_Save_OK', "文件保存成功");
define('lang_File_Save_Error', "文件保存失败");
define('lang_New_File','新文件');
define('lang_No_Extension','你必须添加一个文件拓展名'); 
define('lang_Valid_Extensions','合法的拓展名: %s'); // %s = txt,log etc.
