    ...
    angular
        ...
        .factory('OrgService', ['Restangular', function(Restangular){
            ...
            return {
                ...
                search: function(keywords,code) {
                  return Restangular.one('/organization/search/' + keywords + '/' + code).get();
                }
          ...
          return {
            ...
            loadCity: function(provinceName) {
              for (var i = 0; i < provinceList.length; i++) {
                  var currentProvince = provinceList[i];
                  if(currentProvince.name == provinceName) {
                      return currentProvince.cityList;
                  }
              };
            },

            loadDistrict: function(cityList, cityName) {
              for (var i = 0; i < cityList.length; i++) {
                  var currentProvince = cityList[i];
                  if(currentProvince.name == cityName) {
                      return currentProvince.areaList;
                  }
              };
            }
