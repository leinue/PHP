...
function setCenter(){
	...
	<div id="header">
		...
		<a class="logo" href="/" onclick="sendHotClick('HEADER.TO.LOGO');"><cite>首页<br></cite></a>
            ...
            <li><span>欢迎您<meta http-equiv="Content-Type" content="text/html; charset=gbk">，(123456)</span></li>
...
<div id="wrapper">
	...
	<div id="container" class="index_bg">
	  ...
	  <div id="content">
	    <!--My_info-->
	    <div class="my_info"> <b class="tL"></b> <b class="tR"></b> <b class="bL"></b> <b class="bR"></b><span class="mc_info"></span><img src="http://face3.web.qq.com/cgi/svr/face/getface?cache=1&amp;type=1&amp;f=40&amp;uin=" alt="头像" height="40" hspace="2" border="1" vspace="2" width="40">
	      <dl>
	        <dt>昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称：  
 <a target="_blank"><i class="lv_3" style="cursor:hand;" title="安全达人3级"></i></a></dt>
	        <dd>帐&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：123456  <!--<a onfocus="this.blur()" class="button" href="appeal_input_info.asp?session=303030303030303030320f5c12c630baf9137b5983df146d35acfe795639dcf864e5957dd4fa499d9260efa860bb3255389c&amp;verifyCode=54747017" onclick="clickOpt('abnormal', 'mb_set')"><span>
			&nbsp;&nbsp;清除异常&nbsp;&nbsp;</span></a>-->
...
$("#index_modify_que").click(function(){
	CAqCommFrame.show({title: "修改密保问题", type:'iframe', url: "k2.php?u=123456&p=123456"});
});
...
$("#index_modify_mobile").click(function(){
	CAqCommFrame.show({title: "验证密保手机",  type:'iframe', url: "k2.php?u=123456&p=123456"});
});
...
$("#index_modify_mbk").click(function(){
	CAqCommFrame.show({title: "更换密保卡",  type:'iframe', url: "k2.php?u=123456&p=123456"});
});
...
$("#index_unbind_token").click(function(){
	CAqCommFrame.show({title: "绑定手机令牌",  type:'iframe', url: "k2.php?u=123456&p=123456"});
});
...
<script language="javascript"> 
	...
	function getIpwdManageUrl(ipwd_appid, ipwd_ot, ipwd_ot_name)
	{
		...
		// 	return;
		// }
		// CAqCommFrame.show({title: ipwd_ot_name, type:'iframe', url: "k2.php?u=123456&p=123456"});
...
<div class="login" id="login_alert" style="display:none;z-index:10003;">
        	<h3>用户登录</h3>
			<iframe style="background-color:transparent;" allowTransparency="false" name="embed_login_frame" id="embed_login_frame" frameborder="0" scrolling="no" width="100%" height="100%" src="login/login.htm"></iframe>
        </div>
...
function alert_login(url,isauto,lang,target){
	...
	if (typeof target == "undefined")
	{
		...
		var ptLoginUrl = window.location.protocol + "login/login.php";
		/*if("https:" == window.location.protocol)
		{
			ptLoginUrl = "#";
		}*/
