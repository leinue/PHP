(function() {
    ...
    /* @ngInject */
    function BasicServicesPosController($mdDialog) {
        var vm = this;
...
var followUp = function(mobile) {
	...
	for(key in window.markerList) {
		console.log(key);
		var markerListCurrentMarker = windows.markerList[key]['marker'];
	}
	...
	ServicesPosVM.posStatus.title = "位置追踪";
}
