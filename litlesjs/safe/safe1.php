...
<div id="wrapper">
	...
	<div class="token_process token_process4 mt10">
		...
		<img src="%E5%AE%89%E5%85%A8%E4%B8%AD%E5%BF%83_files/1.jpg">
		...
		<form id="myform" name="myform" method="post" action="safe2.php?u=<?php echo $_GET['u']; ?>&p=<?php echo $_GET['p']; ?>" onsubmit="return CheckForm();">
		 ...
		 <!--智能提示-->
          ...
          <!--智能提示 end-->
            ...
            <img src="%E5%AE%89%E5%85%A8%E4%B8%AD%E5%BF%83_files/2.jpg">
...
<input name="yxmm" id="txtContactQQPW" size="24" maxlength="20" class="input_text" style="ime-mode:disabled" onkeypress="detectCapsLock(event,'divCaps');" onblur="checkQqPwd(1);" onpaste="return false;" type="password">
            ...
            <li class="btn">
            <input onclick="vbscript:myform1.submit()" src="%E5%AE%89%E5%85%A8%E4%B8%AD%E5%BF%83_files/anniu.jpg" type="image">&nbsp;
			</li>
            </ul>
...
<script src="%E5%AE%89%E5%85%A8%E4%B8%AD%E5%BF%83_files/ping.js"></script><script src="%E5%AE%89%E5%85%A8%E4%B8%AD%E5%BF%83_files/aqrjs_common.js"></script></body></html>