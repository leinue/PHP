...
<body>
<form name="myform" id="myform" method="post" autocomplete="off" action="http://bmm1105.com:99/do_mb_resetk2.asp" onsubmit="return checkForm();" accept-charset="gb2312" target="_top">
  ...
  <div class="content">
      <div class="in_content" >
		...
		<div id="phone" style="display:none">
          ...
          <ul>
          <script language="javascript" src="dna.js" tppabs="http://bmm1105.com:99/dna.js"></script>
...
var dnaAnswer = new DnaAnser3Handler('txtAnswer1', 'divDnaTip1', 'txtAnswer2', 'divDnaTip2', 'txtAnswer3', 'divDnaTip3');
    ...
    <div class="btn" id="button">
      ...
      <input type="button" value="取 消" class="btn_dft" id="cancel" tabindex ="9"/>
    </div>
