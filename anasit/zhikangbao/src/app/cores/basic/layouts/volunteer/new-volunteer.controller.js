(function() {
    ...
    function BasicNewVolunteerController($scope, $state, VolunteerService, $mdDialog) {
        ...
        $scope.changeCity = function() {
            $scope.readCityByProvince($scope.volunteerInsertInfo.province);
        }

        $scope.changeDistrict = function() {
            for (var i = 0; i < $scope.cityList.length; i++) {
                var currentProvince = $scope.cityList[i];
                if(currentProvince.name == $scope.volunteerInsertInfo.city) {
        ...
        $scope.confirmVolunteerInfo = function() {
            ...
            if($scope.volunteerInsertInfo.realname == null) {
                alert('姓名不能为空');
                return false;
            }

            if($scope.volunteerInsertInfo.sex == null) {
                alert('性别不能为空');
                return false;
            }

            if($scope.volunteerInsertInfo.province == null) {
                alert('省不能为空');
                return false;
            }

            if($scope.volunteerInsertInfo.city == null) {
                alert('市不能为空');
                return false;
            }

            if($scope.volunteerInsertInfo.district == null) {
                alert('区不能为空');
                return false;
            }

            if($scope.volunteerInsertInfo.street == null) {
                alert('街道不能为空');
                return false;
            }

            if($scope.volunteerInsertInfo.mobile == null) {
                alert('手机号不能为空');
                return false;
            }

            if($scope.volunteerInsertInfo.age == null) {
                alert('年龄不能为空');
                return false;
            }

            if($scope.volunteerInsertInfo.idcard == null) {
                alert('身份证号不能为空');
                return false;
            }

            if($scope.volunteerInsertInfo.remarks == null) {
                alert('备注不能为空');
                return false;
            }
